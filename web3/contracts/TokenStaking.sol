...
//edite stack -> stak
// need to transform stak-> stake where it is necessary
// IMPORTING CONTRACTS
...
contract TokenStaking is Ownable, ReentrancyGuard, Initializable {
    ...
    */
    ...
    // diff--> function getStakStartDate() external view returns (uint256) {
    ...
    */
    ...
    // diff->> function getStakEndDate() external view returns (uint256) {
    ...
    */
    ...
    // diff--> function toggleStaking() external onlyOwner {
    ...
    */
    ...
    //diff--> function claimReward() external nonReentrant whenTreasuryHasBalance(_users[msg.sender]. rewardAmount) {
